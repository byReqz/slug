...
// NewConsoleLoggerSet returns a default set of ConsoleLoggers using the slug formatting. Warnings and errors will be printed to stderr, everthing else to stdout.
